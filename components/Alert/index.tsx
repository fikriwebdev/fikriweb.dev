    ...
    "flex items-center gap-4 p-4 font-light rounded-md flex-1 [&>span]:rounded-full",
    {
        variants: {
            status: {
                ...
                error: "bg-red-300 [&>span]:bg-red-600 [&>span>svg]:text-white dark:[&>span>svg]:text-black   dark:[&>span]:bg-red-300/80 [&>span]:p-1 border-red-500 border-0",
                warning:
            ...
            variant: {
                subtle: "bg-opacity-100 dark:bg-opacity-20 dark:text-gray-50 text-gray-800 ",
                solid: "bg-opacity-100 [&>span]:bg-gray-900 text-gray-50 dark:text-gray-800 [&>span]:p-1 [&>span>svg]:text-white ",
                "left-accent":
