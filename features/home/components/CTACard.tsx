...
export default function CTACard() {
    return (
        <section>
            <div className="mt-16 flex flex-col justify-center  mx-auto relative w-full rounded-md overflow-hidden bg-gray-100 dark:bg-gray-800">
                <div className="absolute -left-1/2 -right-1/2  animate-rotate bg-gradient-to-r from-gray-900 dark:from-white via-transparent to-transparent dark:via-transparent dark:to-transparent w-[200%] h-[700%] transform rotate-90  z-10"></div>
                <div className="bg-gray-200 dark:bg-gray-800 m-1  flex flex-col items-center relative z-10 rounded-md">
                    <div className="max-w-xl py-8 flex flex-col items-center px-4">
                        <p className="text-xl md:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-black dark:from-white to-gray-300  dark:to-gray-700 text-center">
                            ...
                            Tell me about your next project and let&apos;s
