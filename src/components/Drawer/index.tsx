    ...
    "bg-white dark:bg-gray-800  fixed  z-[5000]  p-4    shadow-lg dark:shadow-2xl focus:outline-none ",
    {
        variants: {
            position: {
                ...
                right: "data-[state=open]:animate-slideRightShow data-[state=closed]:animate-slideRightHide bottom-0 top-0 right-0 w-[90vw] max-w-[300px] h-screen",
                top: "data-[state=open]:animate-slideTopShow data-[state=closed]:animate-slideTopHide w-screen h-1/3 top-0 left-0 right-0",
                bottom: "data-[state=open]:animate-slideBottomShow data-[state=closed]:animate-slideBottomHide w-screen h-1/3 bottom-0 left-0 right-0",
            },
        },
        defaultVariants: {
            position: "left",
...
>((props, ref) => {
    ...
    return (
        <RadixDialog.Close ref={ref} className={clsm(className)} {...rest} />
    );
});
