...
date: "18 July 2023"
description: "Create reusable button that support multi variants with tailwindcss & class-variance-authority"
...
<div className="flex flex-col gap-4 items-start p-4  w-full">
    <div className="flex items-center gap-4">
        ...
        <Button variant="filled-danger">Danger</Button>
        <Button variant="filled-warning">Warning</Button>
        <Button variant="filled-success">Success</Button>
    </div>
    <div className="flex items-center gap-4">
        {/* outline */}
...
```terminal
npm install tailwindcss class-variance-authority lucid-react
```
