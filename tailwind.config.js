    ...
    theme: {
        ...
        extend: {
            ...
            animation: {
                ...
                slideLeftShow:
                    "slideLeftShow 0.5s cubic-bezier(0.16, 1, 0.3, 1)",
                slideLeftHide:
                    "slideLeftHide  0.5s cubic-bezier(0.16, 1, 0.3, 1)",
                slideRightShow:
                    "slideRightShow 0.2s cubic-bezier(0.16, 1, 0.3, 1)",
                slideRightHide:
                    "slideRightHide  0.1s cubic-bezier(0.16, 1, 0.3, 1)",
                slideTopShow: "slideTopShow 0.2s cubic-bezier(0.16, 1, 0.3, 1)",
                slideTopHide:
                    "slideTopHide  0.1s cubic-bezier(0.16, 1, 0.3, 1)",
                slideBottomShow:
                    "slideBottomShow 0.2s cubic-bezier(0.16, 1, 0.3, 1)",
                slideBottomHide:
                    "slideBottomHide  0.1s cubic-bezier(0.16, 1, 0.3, 1)",
